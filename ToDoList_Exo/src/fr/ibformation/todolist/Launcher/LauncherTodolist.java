...
public class LauncherTodolist {
	...
	public static final String SHOW = "Afficher la liste des éléments";
	public static final String ADD = "Ajouter un élément";
	public static final String DELETE = "Supprimer un élément";
	public static final String SET = "Modifier un élément";
	...
	public static void main(String[] args) {
		...
		do {	
			...
			case 2 :
				...
				System.out.println("quantité de ce produit : ");
			...
			case 4 :
				...
				for (int i=0; i < shoppingList.size(); i++) {
					...
					System.out.println("souhaitez vous modifier la quantité du produit ? (true/false) ");
					boolean modifQuantity = scanner.nextBoolean();
					if (modifQuantity==true) {
						System.out.println("nouvelle quantité du produit : ");
						course.setQuantity(scanner.nextInt());
